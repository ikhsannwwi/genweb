...
$('[data-background-src]').each(function() {
	var gradientState = $(this).data('gradient');
	var gradientColor = $(this).data('gradient-color');
	if (gradientState && gradientState == true) {
		gradientColor = gradientColor + ', '
	} else {
		gradientColor = ''
	}
	var backgroundUrl = $(this).data('background-src');
	if (backgroundUrl) {
		$(this).css('background-image', `${gradientColor} url('${backgroundUrl}')`);
	}
});